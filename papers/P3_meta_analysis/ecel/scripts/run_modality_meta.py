...
Usage:
    python papers/P3_meta_analysis/ecel/scripts/run_modality_meta.py

Outputs (to papers/P3_meta_analysis/ecel/results/):
...
RESULTS_DIR = REPO_ROOT / "papers" / "P3_meta_analysis" / "ecel" / "results"
...
def write_summary_md(per_trait_results: dict[str, dict],
    ...
    lines = [
        ...
        "",
        f"**Generated by**: `papers/P3_meta_analysis/ecel/scripts/run_modality_meta.py`",
        f"**Input**: `papers/P3_meta_analysis/inputs/studies.csv`",
