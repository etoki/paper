...
Usage:
    python papers/P3_meta_analysis/iceel/scripts/run_hofstede_meta.py

Outputs (to papers/P3_meta_analysis/iceel/results/):
...
RESULTS_DIR = REPO_ROOT / "papers" / "P3_meta_analysis" / "iceel" / "results"
