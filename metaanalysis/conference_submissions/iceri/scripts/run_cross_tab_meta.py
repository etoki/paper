...
Usage:
    python metaanalysis/conference_submissions/iceri/scripts/run_cross_tab_meta.py

Outputs (to metaanalysis/conference_submissions/iceri/results/):
...
RESULTS_DIR = REPO_ROOT / "metaanalysis" / "conference_submissions" / "iceri" / "results"
