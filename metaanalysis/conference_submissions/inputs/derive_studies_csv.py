"""Derive metaanalysis/conference_submissions/inputs/studies.csv from the master
...
# Manual modality overrides — see metaanalysis/conference_submissions/preprint_audit.md
