# Reference Index — Big Five × Online Learning Meta-Analysis

**目的**: `prior_research/` の 44 PDF と、それら内で引用されている主要参考文献を APA 7th 形式で一元化。執筆時は毎回本ファイルを参照して citation の正確性を担保する。
...
# Part I: 本コーパス収録 PDF (44 件)

## I-A. Primary Studies（包含 + 除外判定済）
...
**ID**: A-01 | **Modality**: Fully online async | **Country**: USA | **Era**: pre-COVID | **N**: 92 | **Inclusion**: ✅ Include (primary pool)
...
**ID**: A-02 | **Modality**: Online + Blended | **Country**: Turkey | **Era**: pre-COVID | **N**: 316 (online subset 189) | **Inclusion**: ✅ Include (primary pool, online subset)

### A-03. Ashouri, Taheri, Rasouli, & Rouhalamin (2025) ✅
Ashouri, A., Taheri, M., Rasouli, M., & Rouhalamin, S. (2025). Personality traits and e-learning course satisfaction: A study of health science students. *Cureus, 17*(7), e89131. https://doi.org/10.7759/cureus.89131

**ID**: A-03 | **Modality**: Fully online | **Country**: Iran | **Era**: COVID (2022 data) | **N**: 183 | **Inclusion**: ⚠ Exclude from primary (satisfaction only)
...
**ID**: A-04 | **Modality**: Fully online synchronous | **Country**: Canada (McGill) | **Era**: COVID Fall 2020 | **N**: 350 T1 | **Inclusion**: ⚠ Exclude from primary (engagement/SE only, no GPA)
...
**ID**: A-05 | **Modality**: Fully online | **Country**: Canada (McGill) | **Era**: COVID 2020-2021 | **N**: 678 baseline | **Inclusion**: ❌ Exclude (sample overlap with A-04 Fall 2020 cohort)

### A-06. Sahinidis & Tsaknis (2021) ✅ 🔴 **著者訂正**
Sahinidis, A. G., & Tsaknis, P. A. (2021). Exploring the relationship of the Big Five personality traits with student satisfaction with synchronous online academic learning: The case of Covid-19–induced changes. In A. Kavoura, E. Kefallonitis, & P. Theodoridis (Eds.), *Strategic innovative marketing and tourism* (Springer Proceedings in Business and Economics). Springer.

**ID**: A-06 | **Modality**: Synchronous online (lockdown) | **Country**: Greece (U. of West Attica) | **Era**: COVID Mar-Apr 2020 | **N**: 555 | **Inclusion**: ⚠ Exclude from primary (satisfaction only, non-BFI scale)
**⚠ 訂正**: lit review の「Baruth & Cohen (2021)」は誤り、実際は Sahinidis & Tsaknis (2021)

### A-07. Cohen & Baruth (2017) ✅ 🔴 **著者訂正**
...
**ID**: A-07 | **Modality**: Fully online async | **Country**: Israel (Tel Aviv U.) | **Era**: pre-COVID | **N**: 72 | **Inclusion**: ⚠ Exclude from primary (satisfaction only, N small)
**⚠ 訂正**: lit review の「Baruth & Cohen (2023)」は誤り、実際は 2017 年 Cohen & Baruth

### A-08. Keller & Karau (2013) ✅ 🔴 **著者訂正**
...
**ID**: A-08 | **Modality**: Fully online async (Blackboard) | **Country**: USA | **Era**: pre-COVID | **N**: 250 | **Inclusion**: ⚠ Exclude from primary (OCI perception only)
**⚠ 訂正**: lit review の「Bhagat et al. (2019)」は誤り、実際は Keller & Karau (2013)
...
**ID**: A-09 | **Modality**: **Face-to-face**（オンライン要素なし）| **Country**: India (Tamil Nadu) | **N**: 384 | **Inclusion**: ❌ Exclude — modality ineligible

### A-10. Boonyapison, Sittironnarit, & Rattanaumpawan (2025) ✅ ❌ EXCLUDE
Boonyapison, K., Sittironnarit, G., & Rattanaumpawan, P. (2025). Association between the big five personalities and academic performance among grade 12 students at international high school in Thailand. *Scientific Reports, 15*, 16484. https://doi.org/10.1038/s41598-025-01038-7
