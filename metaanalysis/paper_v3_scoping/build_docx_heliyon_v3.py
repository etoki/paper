...
Generates manuscript_journal_v3_scoping_heliyon.docx using the same source
...
import build_docx_scoping as build_docx
...
def main():
    ...
    out = here / "manuscript_journal_v3_scoping_heliyon.docx"
