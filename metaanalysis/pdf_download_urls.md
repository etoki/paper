...
メタ分析対象の論文 URL と取得状況の一覧。

- ✅ 取得済（`metaanalysis/prior_research/` 配下）
- ⬜ 未取得（要 PDF 入手）
- 📧 著者リクエスト中（ResearchGate または email）
- ❌ スコープ外（メタ分析対象外）
- 📁 既に他フォルダで所持

---

## A. Primary Studies（メタ分析候補）
...
| A-16 | ✅ | Garzón-Umerenkova et al. (2024) | https://pmc.ncbi.nlm.nih.gov/articles/PMC11381604/ |
| A-17 | ✅ | Kara et al. (2024) | https://doi.org/10.1007/s10639-024-12755-3 |
| A-18 | ✅ | Keller & Karau (2013) | https://doi.org/10.1016/j.chb.2013.06.007 |
| A-19 | ✅ | MacLean (2022) | https://ucalgary.scholaris.ca/items/b2b6492b-eb58-4296-9689-717c6641a62a |
| A-20 | ✅ | Mustafa et al. (2022) | https://pmc.ncbi.nlm.nih.gov/articles/PMC9354135/ |
| A-21 | ✅ | Nakayama et al. (2014) | https://files.eric.ed.gov/fulltext/EJ1035656.pdf |
| A-22 | ✅ | Quigley et al. (2022) | https://pmc.ncbi.nlm.nih.gov/articles/PMC8979773/ |
| A-23 | ✅ | Rodrigues et al. (2024) | https://www.mdpi.com/2254-9625/14/2/25 |
...
| ID | Status | Author (Year) | URL |
|----|--------|---------------|-----|
| B-01 | ❌ | Wang, Yu, Wu et al. (2025) MBTI | https://doi.org/10.1007/s10639-024-13161-5 |

## C. Benchmark Meta-Analyses（一般的学業、NOT online）

| ID | Status | Author (Year) | URL |
|----|--------|---------------|-----|
| C-01 | ✅ | Poropat (2009) | https://edci6300introresearch.pbworks.com/f/poropat+2009+metaanalysis+FFM.pdf |
| C-02 | ✅ | Vedel (2014) | https://doi.org/10.1016/j.paid.2014.07.011 |
| C-03 | ✅ | Mammadov (2022) | https://gwern.net/doc/psychology/personality/conscientiousness/2021-mammadov.pdf |
| C-04 | ✅ | Stajkovic et al. (2018) | https://doi.org/10.1016/j.paid.2017.08.014 |
| C-05 | ✅ | McAbee & Oswald (2013) | https://doi.org/10.1037/a0031748 |

## D. Systematic Review

| ID | Status | Author (Year) | URL |
|----|--------|---------------|-----|
| D-01 | ✅ | Gray & DiLoreto (2024) [author TBC] | https://encompass.eku.edu/jote/vol9/iss2/9/ |

## E. Japanese Context（メタ分析対象外、ユーザー判断で除外）

| ID | Status | Author (Year) | URL |
|----|--------|---------------|-----|
| E-01 | ❌ | Kanou (2020) | https://doi.org/10.14935/jssep.44.0_521 |
| E-02 | ❌ | Komiyama (2016) | IPSJ Magazine 57(9), 890–893 |
| E-03 | ❌ | Nishino (2018) [author TBC] | https://www.jstage.jst.go.jp/article/jsee/66/5/66_5_23/_article/-char/ja |
