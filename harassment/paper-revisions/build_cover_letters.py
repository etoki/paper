...
METHODS = (
    ...
    "multicollinearity diagnostics (VIF ≤ 2.00). Hypotheses (H1–H5) "
    "are stated in falsifiable form, including pre-specified pattern-"
    "level predictions across outcomes and across sex. Across models, "
    "psychopathy is a consistent positive predictor of power-"
    "harassment perpetration tendencies (β ≈ .32–.40, p < .001), whereas "
    "Honesty–Humility is negatively associated (β = −.14, p = .049). For "
    "gender-harassment perpetration tendencies, narcissism and psychopathy "
    "are positive predictors, while Honesty–Humility (β = −.23, p < .001) "
    "and Openness (β = −.24, p < .001) are negative predictors; "
    "Machiavellianism shows a negative coefficient that is consistent "
    "in sign with its small bivariate negative correlation in this "
    "sample (ρ ≈ −.10) rather than emerging as a sign reversal under "
    "adjustment, and I do not interpret it as a substantive ‘protective’ "
    "effect. Adding HEXACO yields meaningful incremental variance "
    "(ΔR² = .032, p = .036 for power; ΔR² = .096, p < .001 for gender). "
    "Sex-stratified analyses indicate a divergence in predictor "
    "structure (Openness dominant negative predictor of gender-"
    "harassment perpetration tendencies among men; Honesty–Humility "
    "dominant among women), which I read as a hypothesis-generating "
    "pattern rather than as a confirmed moderation effect. The "
    "manuscript explicitly frames the residual Honesty–Humility "
    "association after adjustment for the Dark Triad as an adjusted "
    "association rather than as evidence of a separable latent fairness/"
    "sincerity factor distinct from antagonism (the latter would require "
    "a latent-variable framework not estimated here). Findings inform "
    "tentative implications for harassment-prevention frameworks; I do "
    "not advocate personality-based selection or screening."
)

COMPLIANCE = (
    "__Compliance and transparency.__ "
    "Ethics approval: Institutional Review Board of the Public Health "
    "Research Foundation (Reference no. 25G0001), an independent ethics "
    "review body unaffiliated with the author and with SUNBLAZE Co., "
    "Ltd. Informed consent was obtained from all participants prior to "
    "questionnaire administration; the dataset retained for analysis "
    "and public release is de-identified (Lancers user identifiers were "
    "collected solely to disburse compensation and were permanently "
    "deleted after payment), and the geographic-area variable was "
    "generalized to three categories (Kanto, Kinki, Other) prior to "
    "public release. "
    "Conflict of interest: I am the founder of SUNBLAZE Co., Ltd. "
    "(Tokyo, Japan), which develops and markets proprietary personality-"
    "assessment and HR-analytics tools. The proprietary instruments "
    "offered by SUNBLAZE do not include the HEXACO-60 or the SD3-J used "
    "in this study, and the present findings are not intended for, and "
    "will not be used in, SUNBLAZE product development, validation, "
    "marketing, or commercial promotion. I nonetheless disclose this "
    "commercial affiliation as a potential perceived conflict of "
    "interest in line with COPE and ICMJE guidance. "
    "Funding: this research was funded entirely from my personal "
    "resources; no external grant from public, commercial, or not-for-"
    "profit funding bodies was received, and SUNBLAZE Co., Ltd. provided "
    "no financial contribution and no in-kind support at any stage of "
    "the research, including any Article Processing Charge."
)
