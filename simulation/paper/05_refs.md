...
Park, J. S., O'Brien, J. C., Cai, C. J., Morris, M. R., Liang, P., & Bernstein, M. S. (2023). Generative agents: Interactive simulacra of human behavior. In *Proceedings of the 36th Annual ACM Symposium on User Interface Software and Technology* (Article 2, pp. 1–22). https://doi.org/10.1145/3586183.3606763
...
Rutter, C. M., Zaslavsky, A. M., & Feuer, E. J. (2011). Dynamic microsimulation models for health outcomes: A review. *Medical Decision Making, 31*(1), 10–18. https://doi.org/10.1177/0272989X10369005
...
Sleep, C. E., & Watts, A. L. (2024). Personality change interventions: A systematic review and meta-analysis. *Personality Science*, advance online publication. [Placeholder pending final publication; pre-print available at PsyArXiv.]
...
Tou, Y. (2017). Development of a workplace power harassment scale [in Japanese]. *Japanese Journal of Industrial-Organizational Psychology, [year/vol pending]*. [Placeholder for original Japanese-language reference.]
...
1. Citations marked "[Placeholder ... pending]" require the investigator to verify the original publication metadata. The substantive content of the cited claim is not affected by the placeholder.
2. Tokiwa (2024, IEEE) and Tokiwa (2025, harassment preprint) are self-citations; final DOIs/URLs to be inserted at submission time.
3. MHLW survey series citations point to the Japanese government MHLW website; English-language summaries are available at the same URL with `?lang=en` query parameter (verification recommended at submission time).
4. The Sleep & Watts (2024) reference is forthcoming; if not yet published at submission time, the manuscript will substitute Hudson & Fraley (2015) as the principal personality-change-intervention citation.
