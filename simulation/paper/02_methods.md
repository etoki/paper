...
- **Restricted tier** (IRB-approved access request): The N = 354 individual-level harassment dataset is hosted in a Private OSF component linked from the v2.0 working project. The component's Wiki documents the four data-use terms (research-purpose-bounded use; non-redistribution; required citation of Tokiwa 2025 Research Square preprint and the v2.0 OSF DOI; IRB acknowledgement). Approved requesters are added as read-only contributors within 14 days. Methodological details of the underlying survey are reported in Tokiwa (2025, Research Square preprint; DOI 10.21203/rs.3.rs-7756124/v1).
