...
**Caption.** *H7 IUT classification under cultural attenuation factors F ∈ {0.3, 0.5, 0.7, 1.0}. The REVERSAL classification (structural dominance) is preserved across all four factors, including the Sapouna (2010) UK→Germany worst-case anchor (F = 0.3) and the Nielsen (2017) Asia/Oceania expected attenuation (F = 0.5).*
