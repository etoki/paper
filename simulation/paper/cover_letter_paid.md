...
This manuscript directly extends the HEXACO–workplace-bullying literature that PAID has been a major venue for, including the Nielsen et al. (2017) meta-analysis (PAID 104:195–206), Linton & Power (2013) (PAID 54:738–743), Lee et al. (2013) (companion HEXACO + Dark Triad work in *European Journal of Personality*), and Pilch & Turska (2015) (Machiavellianism × bullying). Our novel contribution is to convert these well-replicated personality–harassment associations into a counterfactual-microsimulation framework that quantifies, for the first time, the population-level prevalence consequence of realistic personality interventions versus structural ones — addressing the practical question of intervention prioritization that PAID's I/O readership routinely asks.

The "dominates" framing in the title is calibrated to the actual ratio (|ΔP_C| / |ΔP_A| ≈ 5.7) and is methodologically conservative: we explicitly reject the stronger claim that personality interventions "do not work" in favor of the empirical observation that structural interventions *outperform* them by ~5.7× under realistic effect-size assumptions.
...
Per *Personality and Individual Differences* guidelines, the following authors of works cited in the manuscript have publicly demonstrated expertise relevant to the topic and have no known conflict of interest with the author:

- **Michael C. Ashton** (Brock University, Canada) — co-creator of the HEXACO model (Ashton & Lee, 2007, 2009); foundational expertise in the HEXACO personality framework that this manuscript operationalizes.
- **Kibeom Lee** (University of Calgary, Canada) — HEXACO co-creator and lead author of Lee et al. (2013) on HEXACO + Dark Triad correlates of antisocial workplace behavior.
- **Morten Birkeland Nielsen** (National Institute of Occupational Health, Norway) — first author of Nielsen et al. (2017) PAID meta-analysis on workplace harassment and the Five-Factor Model; directly relevant to our cross-cultural transportability sweep.
...
I confirm that this manuscript has not been previously published in any peer-reviewed venue and is not under consideration at any other journal. A non-peer-reviewed version has been posted as a preprint at SocArXiv (DOI 10.31235/osf.io/p2d8w_v1) per *Personality and Individual Differences* preprint policy. The submission is sole-authored. Code, data, and intermediate artifacts will remain publicly accessible at the indicated OSF DOI and GitHub repository for the duration of peer review and beyond.
