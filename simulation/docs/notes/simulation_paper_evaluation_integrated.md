...
8. **新規性評価が微妙**
   ...
   - LLM のバイアス研究（Salecha et al. 2024 の social desirability bias、Wang et al. 2024 の flattening 等）が並行進行
...
- **Self-report と behavior の解離**（Han et al. 2025, "The Personality Illusion"）
- **Analytic flexibility**：prompt/model 選択の自由度が信頼性を破壊（Cummins 2025, "The threat of analytic flexibility"）
...
代表例：
- **Wang, Morgenstern, & Dickerson (2024)** "LLMs that replace human participants can harmfully misportray and flatten identity groups"：misportrayal と flattening を分類
- **Peng et al. (2025)** "Digital Twins are Funhouse Mirrors"：5 種類の systematic distortion を分類
- **Han et al. (2025)** "The Personality Illusion"：LLM の self-report と behavior の解離を示す
- **Cummins (2025)** "The threat of analytic flexibility"：解析の柔軟性が信頼性を破壊する
...
- Peng, T., Gui, G., Brucks, M., Merlau, D. J., et al. (2025). *Digital Twins are Funhouse Mirrors: Five Systematic Distortions*. arXiv:2509.19088. [in `simulation/prior_research/_text/`]
- Han, P., Kocielnik, R., Song, P., Debnath, R., Mobbs, D., Anandkumar, A., & Alvarez, R. M. (2025). *The Personality Illusion: Revealing Dissociation Between Self-Reports & Behavior in LLMs*. arXiv:2509.03730. [in `simulation/prior_research/_text/`]
- Cummins, J. (2025). The threat of analytic flexibility in using large language models to simulate human data. *Advances in Methods and Practices in Psychological Science*. https://doi.org/10.1177/25152459251325174 [in `simulation/prior_research/_text/`]
